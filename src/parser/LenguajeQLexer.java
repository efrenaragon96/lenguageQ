...
public class LenguajeQLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "TK_BEGIN", "TK_END", "TK_PRINT", "TK_PRINTLN", 
			"TK_READ", "TK_TIPO_INT", "TK_TIPO_FLOAT", "TK_TIPO_STRING", "TK_IF", 
			"TK_ELSE", "TK_TIMES", "TK_MEAN", "TK_CTE_INT", "TK_CTE_HEX", "TK_CTE_FLOAT", 
			"TK_CTE_STRING", "ESC", "TK_ID", "LETRA", "DIGITO", "LINE_COMMENT", "COMMENT", 
			"WS"
		};
	}
	...
	public LenguajeQLexer(CharStream input) {
		super(input);
